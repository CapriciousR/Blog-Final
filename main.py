...
def register():
    ...
    if form.validate_on_submit():
        ...
        if user:
            flash("A user with this email already exists. Login instead.")
...
def login():
    ...
    if form.validate_on_submit():
        ...
        user = result.scalar()
        if not user:
            flash("An user with this email doesn't exist. Please try again.")
            return redirect(url_for("login"))
        else:
            if check_password_hash(pwhash=user.password,password=form.password.data):
                ...
                flash("The email and password doesn't match. Please try again.")
                return redirect(url_for("login"))
